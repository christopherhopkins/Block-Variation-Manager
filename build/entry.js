...
function initVariationEditor(blockType) {
  ...
  (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_0__.subscribe)(() => {
    ...
    if (!seededOnce && blocks.length === 0) {
      seededOnce = true;
      const newBlock = (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.createBlock)(blockType);
      (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_0__.dispatch)('core/block-editor').resetBlocks([newBlock]);
      return;
    }
    if (blocks.length > 0) {
      seededOnce = true;
    ...
    if (!lockedOnce && blocks.length > 0) {
      ...
      const updateSettings = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_0__.dispatch)('core/block-editor')?.updateSettings;
...
function SourcePanel({
  ...
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Unlink this block from its variation? It will keep its current values but stop receiving future updates.', 'block-variation-manager')), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.__experimentalText, {
    as: "p",
    variant: "muted",
    size: "12",
    style: {
